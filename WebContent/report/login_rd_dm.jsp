...
<%
	...
	if(!u_name.equals("") && !pass.equals(""))
	{
			...
			if(u_name.equals("rdmag") && pass.equals("rdmag@123") )
				response.sendRedirect("reportform_rd_dm.jsp?search=detailed");	
...
<FORM action="login_rd_dm.jsp" method = "post" name = "myloginform" onsubmit = "return check_form()">
