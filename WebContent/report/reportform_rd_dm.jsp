...
var Year1 = todaydate.getFullYear(); 
 ...
 // alert("CurrentDaysInSelection :"+CurrentDaysInSelection);
  ...
  if (DaysForThisSelection > CurrentDaysInSelection)
  {
	...
	<table width="1386" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor=lightblue bordercolor=blue>
...
<br>		<form name="Merchant1" method="post" action="report_rd_dm_all.jsp">
...
<option value="2015"> 2015 </option>
 ...
 <option value="2015"> 2015 </option>
	...
	<input type="hidden" name="searchCreteria" value="<%=request.getParameter("search")%>">
