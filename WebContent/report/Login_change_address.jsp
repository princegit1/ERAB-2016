...
<%
	...
	if(!u_name.equals("") && !pass.equals(""))
	{
			...
			if(u_name.equals("rdreport") && pass.equals("rdreport@change") )
				response.sendRedirect("reportform_change_address.jsp?search=detailed");	
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr align="center" bgcolor="black"> 
    ...
    <h3><font size="+5">RD change Address Report</font></h3>
    </font></td>
</tr>
<tr align="center"> 
    <td colspan="3" >&nbsp; </td>
...
<FORM action="Login_change_address.jsp" method = "post" name = "myloginform" onsubmit = "return check_form()">
