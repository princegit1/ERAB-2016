...
<%
	...
	if(!u_name.equals("") && !pass.equals(""))
	{
			...
			if(u_name.equals("rdreport") && pass.equals("rdreport@missing") )
				response.sendRedirect("reportform_missing_copy.jsp?search=detailed");	
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr align="center" bgcolor="black"> 
    ...
    <h3><font size="+3">RD Missing/Damaged Copies Report</font></h3>
    </font></td>
</tr>
<tr align="center"> 
    <td colspan="3" >&nbsp; </td>
...
<FORM action="Login_missing_copy.jsp" method = "post" name = "myloginform" onsubmit = "return check_form()">
