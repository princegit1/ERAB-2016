...
<P>&nbsp;</P>
	...
	<input type="hidden" name="setradio" value="<%=setradio%>">
...
<tr valign="top" align="center">  <td colspan="1" height="29"> <input type="radio" name="paytype" value="online" ></td><td colspan="3" height="29"><font  size="3">Online Payment</font></td></tr>
