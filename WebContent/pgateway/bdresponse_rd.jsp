...
oHashMap.put("RD","http://subscription.readersdigest.in/rdindia/status/status.jsp");
...
System.out.println("RD-pgform---->"+redirectURL);
System.out.println("RD-RespCode---->"+AuthStatus);
System.out.println("RD-TxnID---->"+CustomerID);
System.out.println("RD-Message---->"+ErrorDescription);
System.out.println("RD-Amount---->"+TxnAmount );
%>
<body onLoad="document.pgform.submit();">
<CENTER>
<IMG SRC="SplashPageLoader.gif">
...
System.out.println("RD-RespCode for invalid transaction---->"+AuthStatus);
System.out.println("RD-TxnID for invalid transaction---->"+CustomerID);
System.out.println("RD-Message for invalid transaction---->"+ErrorDescription);
System.out.println("RD-Amount for invalid transaction---->"+TxnAmount );
