...
*/		
	   if (CustomerID.indexOf("-")>0){
		...
		oHashMap.put("ITE","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITH","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITTL","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITI","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITB","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITT","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITM","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
		oHashMap.put("ITT","http://subscriptions.digitaltoday.in/subscriptions/itoday/billstatus.jsp");
...
oHashMap.put("RD","http://subscription.rd-india.com/rdindia/status/status.jsp");
	   String splitArr2	=	CustomerID.substring(0,2);
	   if( oHashMap.containsKey(splitArr2))
	   {
		redirectURL	=	(String)oHashMap.get(splitArr2);
	   }
%>
<body onLoad="document.pgform.submit();">
<CENTER>
